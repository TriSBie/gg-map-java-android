...
public abstract class PermissionUtils {
    ...
    public static class PermissionDeniedDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage("This sample needs permission to access your location to function properly.")
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (finishActivity) {
                Toast.makeText(getActivity(), "Permission required to continue.",
    ...
    public static class RationaleDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage("This app needs permission to access your location to show your location on the map.")
